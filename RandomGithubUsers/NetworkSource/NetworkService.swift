...
class NetworkService{
    ...
    static private let baseURL = "https://api.github.com/users"
    static private let token = Bundle.main.object(forInfoDictionaryKey: "API_TOKEN") as? String
    static private let userCount = "20"
